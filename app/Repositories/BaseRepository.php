...
abstract class BaseRepository implements RepositoryContract
{
    ...
    public function pluck($field): array
    {
        ...
        $values = $this->query->pluck($field)->toArray();
     ...
     *
     * @param array $attributes Data to be inserted or updated.
     * @param array $uniqueBy Columns to determine uniqueness.
     * @param array $updateColumns Columns to be updated if duplicate.
     * @return bool
     */
    public function upsert(array $attributes, array $uniqueBy, array $updateColumns)
    {
        return $this->model->upsert($attributes, $uniqueBy, $updateColumns);
    }
    ...
    /**
     * Update mutiple model record in the database.
     *
     * @param array $ids
     * @param array $data
     *
     * @return bool
     */
    public function updateMultipleById($ids, array $data)
    {
        $this->unsetClauses();
        try {
            foreach ($ids as $id) {
    ...
    protected function setClauses()
    {
        ...
        foreach ($this->whereIns as $whereIn) {
            if (isset($whereIn['not']) && $whereIn['not'] === true) {
