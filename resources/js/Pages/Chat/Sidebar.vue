<template>
    ...
    <div class="p-4 sm:ml-64">
        ...
        >
            ...
            <div
                class="mb-4 flex h-48 items-center justify-center rounded bg-gray-50 dark:bg-gray-800"
            >
                <p class="text-2xl text-gray-400 dark:text-gray-500">
                    <svg
                        class="h-3.5 w-3.5"
            ...
            <div class="mb-4 grid grid-cols-2 gap-4">
                <div
                    class="flex h-28 items-center justify-center rounded bg-gray-50 dark:bg-gray-800"
                >
                    <p class="text-2xl text-gray-400 dark:text-gray-500">
                        <svg
                            class="h-3.5 w-3.5"
